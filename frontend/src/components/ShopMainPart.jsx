    ...
    return (
        <>
            ...
            <div className="container mt-5 pt-3">
                {/* Navbar */}
                <nav className="navbar navbar-expand-lg navbar-dark primary-color mt-5 mb-5">
                    {/* Navbar brand */}
                    <div className="container">
                        <div className="panel panel-default">
                            <div className="panel-heading badge badge-danger mb-2" style={{ fontSize: "20px" }}>
                                <FontAwesomeIcon icon="fa-solid fa-triangle-exclamation" style={{ fontSize: "20px" }} /> AVISO IMPORTANTE. :*
                            </div>
                            <div className="panel-body">
                                <fieldset className="col-md-12">
                                    <legend>
                                        <code style={{ fontSize: "15px" }}>
                                            1) POR FAVOR TIENES QUE MOVER EL RANGO DE PRECIOS.
                                        </code>
                                    </legend>
                                    <div className="panel panel-default">
                                        <div className="panel-body">
                                            <p>
                                                <a className="font-weight-bold white-text mr-4" href="#!">
                                                    <h4 className="s-filters badge badge-warning mb-2" style={{ fontSize: "15px" }}>
                                                        <FontAwesomeIcon icon="fa-solid fa-dollar-sign" style={{ fontSize: "15px" }} /> DONDE DICE AQUÍ <br /> $ 500.000 Hasta $ 6.000.000 - COP. :*
                                                    </h4>
                                                </a>
                                            </p>
                                        </div>
